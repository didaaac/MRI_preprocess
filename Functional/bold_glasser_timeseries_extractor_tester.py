...
from extracting_timeseries import Glasser
...
for subj in list_subjs:
    output_file="/home/mariacabello/wf_workspace/thesis_data/timeseries/glasser360/{subject_id}_timeseries_glasser360.txt".format(subject_id=subj)
    ...
    glasser.extract_timeseries(subj, bold_img_filename, output_file)
